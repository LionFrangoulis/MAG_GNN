...
class cfconv(nn.Module):
    ...
    def __init__(self, feature_number, rbf_number,sbf_number,ghost_killer):
        ...
        self.filter_layer_1=nn.Linear(self.rbf_number+self.sbf_number,self.feature_number, bias=not ghost_killer)
        #self.ssp=SSP()
        self.ssp=torch.nn.ELU()
    ...
    def forward(self,x,rbf,sbf,atom_number):
        ...
        filter_inputs=torch.cat([torch.reshape(rbf,(-1,self.rbf_number)),torch.reshape(sbf,(-1,self.sbf_number))],axis=1)
...
class interaction(nn.Module):
    ...
    def __init__(self,feature_number, rbf_number,sbf_number,ghost_killer):
        ...
        self.cfconv1=cfconv(self.feature_number, self.rbf_number,self.sbf_number,ghost_killer)
        #self.ssp=SSP()
        self.ssp=torch.nn.ELU()
    ...
    def forward(self, x, rbf, sbf, atom_number):
        ...
        v=self.cfconv1(v,rbf,sbf,atom_number)  # NO OF ATOMS IS ONLY FOR FIXING THE DIM OF MATRICES. 
